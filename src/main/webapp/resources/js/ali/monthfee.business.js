...
function _pay() {
	...
	$.ajax({
		type : 'post',
		url : contextPath + '/ali/d/pay/getSignMonthFee',
		data : {
			aliAppId : aliAppId,
			aliUserId : aliUserId,
		...
		success : function(result) {
			if (result.isOk) {
				...
				if(rechargeMethods == 34){
					location.href = contextPath + "/ali/j/pay/payMonthSuccess?aliAppId=" + aliAppId + "&aliUserId=" + aliUserId + "&sn=" + sn;
				}else{
...
//				        	   location.href = contextPath + "/ali/j/pay/payMonthSuccess?aliAppId=" + aliAppId + "&aliUserId=" + aliUserId + "&sn=" + sn + "isPay=1";
//				           }else{
//				        	   $.ajax({
//				        			type : 'post',
//				        			url : contextPath + '/ali/d/pay/cancelOrder',
//				        			data : {
//				        				sn : sn,
//				        				aliAppId : aliAppId,
//				        				aliUserId : aliUserId,
//				        				aliErrMsg : res.err_msg
//				        			},
//				        			dataType : "json",
//				        			success : function(result) {
//				        			},
...
function queryMonthFee(){
	...
	$.ajax({
		type : 'post',
		url : contextPath + '/ali/d/pay/queryMonthFee',
		data : {
			aliAppId : aliAppId,
			aliUserId : aliUserId,
			months : months,
...
function getLastmonlog(){
	$.ajax({
		type : 'post',
		url : contextPath + '/ali/d/pay/getLastMonthFeeLog',
		data : {
			aliAppId : aliAppId,
			aliUserId : aliUserId
		},
