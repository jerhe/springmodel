...
/***/ function(module, exports, __webpack_require__) {
	...
	var cubicbezier = __webpack_require__(25);
	var motion = __webpack_require__(48);
	var gesture = __webpack_require__(41);
...
/***/ function(module, exports, __webpack_require__) {
	...
	//引入模板
	var tplRender = __webpack_require__(61);
	var scrollObj = __webpack_require__(44);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _pageview = __webpack_require__(59);

	var _pageview2 = _interopRequireDefault(_pageview);

	var _underscore = __webpack_require__(315);

	var _underscore2 = _interopRequireDefault(_underscore);

	var _geo = __webpack_require__(331);
	...
	_factory2.default.create('carport.detail', function () {
	    ...
	    function _initNavigation(opts) {
	        ...
	        wx.ready(function () {
	            $(opts.navigationEl).on('click', function () {
	                var gcj02tobd09 = _geo2.default.gcj02tobd09(opts.longitude, opts.latitude);
	                wx.openLocation({
	                    latitude: gcj02tobd09[1], // 纬度，浮点数，范围为90 ~ -90
	                    longitude: gcj02tobd09[0], // 经度，浮点数，范围为180 ~ -180。
	                    name: opts.name, // 位置名
	    ...
	    function _bindEvent(opts) {
	        $(opts.contentEl).delegate('.carport-item', 'click', function (e) {
	            opts.onClick(this);
	        });
	    }
	    return {
