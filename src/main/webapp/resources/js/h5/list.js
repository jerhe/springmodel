...
/***/ function(module, exports) {
	...
	module.exports = function (value) {
		var map = {
			'AM_CARPAR_BALLOG': '临停发票',
			'AM_CARMON_BALLOG': '月租发票'
		};
		if (map.hasOwnProperty(value)) {
			return map[value];
		} else {
...
/***/ function(module, exports) {
	...
	module.exports = function (value, viewUrl) {
		...
		if (value == 2) {
			return '<a class="invoice-check" href="' + viewUrl + '">' + statusStr + '</a>';
		} else if (value == 1 || value == 22 || value == 21 || value == 3) {
			return '<a class="invoice-check">' + statusStr + '</a>';
		} else if (value == -1 || value == 23) {
			return '<a class="invoice-failure">' + statusStr + '</a>';
		} else {
			return statusStr;
		}
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _invoiceItem = __webpack_require__(789);

	var _invoiceItem2 = _interopRequireDefault(_invoiceItem);

	var _billRushRed = __webpack_require__(783);

	var _billRushRed2 = _interopRequireDefault(_billRushRed);

	var _listReason = __webpack_require__(790);

	var _listReason2 = _interopRequireDefault(_listReason);
	...
	var _dialog;
	var _billRushRedDialog;
	var dialogChangeSeason; //变更按钮弹出框模版
	var dialogChangeText;
	var resData; //页面加载ajax请求返回参数
	var changeApi; //更改按钮api
	var billNoteId; //缓存 存点击变更按钮发票id
	var openId;
	var clickIndex; //第n个li
	function _initDialog() {
	    _dialog = _dialog3.default.create({ //开票状态提示框
	        title: '提示',
	        content: '',
	        closeBtn: false,
	    ...
	    dialogChangeSeason = _dialog3.default.create({ //变更按钮提示框，填写原因
	        content: '',
	        closeBtn: false,
	        ...
	        buttons: [{
	            ...
	            action: function action() {
	                if ($('.textarea').val() == null || $('.textarea').val() == "") {
	                    _toast2.default.getInstance().show('', "请输入变更原因");
	                } else {
	                    sendAjaxSeason($('.textarea').val());
	                    this.hide();
	                }
	            }
	        }, {
	    ...
	    dialogChangeText = _dialog3.default.create({ //变更按钮提示框，直接返回文字
	        content: '',
	        closeBtn: false,
	        tapMaskToClose: false,
	        buttons: [{
	...
	function handlebarsGetData(res) {
	    var html = (0, _listReason2.default)({
	        checkResult: res.checkResult,
	        checkRemind: res.checkRemind
	    });
	    dialogChangeText.show(html);
	}

	function sendAjaxSeason(val) {
	    (0, _ajax2.default)({
	        url: changeApi,
	        data: {
	            openId: openId,
	            billNoteId: billNoteId,
	            reason: val
	        },
	        done: function done(err, res) {
	            if (!err) {
	                handlebarsGetData(res);
	                if (res.checkResult) {
	                    $('#change').remove();
	                    $('#billkindStatus').text(res.status);
	                    $('#billkindStatus').addClass('invoice-check');
	                } else if (res.checkRemind) {
	                    $('li').eq(clickIndex).find('.change').css("background-color", "#dee2e5");
	                    $('li').eq(clickIndex).find('.change').attr('disabled', 'disabled');
	                }
	            } else {
	                _toast2.default.getInstance().show('', err.msg);
	            }
	        }
	    });
	}

	function _getDataFromServer(fn) {
	    var opts = this.opts;
	    var that = this;
	    (0, _ajax2.default)({
	        url: opts.listApi,
	...
	function _renderList(data) {
	    var opts = this.opts;
	    var $wrap = $(this.opts.listEl);
	    if (data && Object.prototype.toString.call(data) == '[object Array]' && data.length > 0) {
	        //console.log(data,opts.expenseListUrl);
	        var result = (0, _invoiceItem2.default)({
	            data: data,
	            expenseListUrl: opts.expenseListUrl
	        });
	        $wrap.append(result);
	    }
	}
	...
	function _bindEvent() {
	    var $wrap = $(this.opts.listEl);
	    $wrap.on('click', '.invoice-failure', function (e) {
	        e.preventDefault();
	        var msg = $(this).parents('.right-value').data('backMsg');
	        _dialog.show(msg);
	    });

	    // $wrap.delegate('li.invoice-item.success','horizontalpan',function(e){
	    //     var $this = $(this);
	    //     $this.addClass('delete');
	    //     $this.siblings().removeClass('delete')
	    // });
	    $wrap.delegate('.invoice-item.success', 'tap', function () {
	        $(this).removeClass('delete');
	    });
	    $wrap.delegate('.invoice-item-del', 'click', function (e) {
	        e.stopPropagation();
	        var $item = $(this).parents('.invoice-item');
	        var id = $item.data('id');
	        _billRushRedDialog.show((0, _billRushRed2.default)({
	            id: id
	        }));
	    });
	    ...
	    $('body').on('click', '#change', function () {
	        ...
	        var dataId = $(this).parent().parent().data('id'); //获取去li的data-id
	        var index = $(this).parent().parent().index(); //获取第n个元素
	        clickIndex = index;
	        billNoteId = dataId;
	        var html = (0, _listReason2.default)({
	            checkType: resData[index].checkType,
	            checkRemind: resData[index].checkRemind,
	            checkResult: resData[index].checkResult
	        });
	        if (resData[index].checkType) {
	            dialogChangeSeason.show(html);
	        } else {
	            dialogChangeText.show(html);
	        }
	    });
	...
	function _initList() {
	    var opts = this.opts;
	    _getDataFromServer.call(this, _renderList);
	    // PullLoad.create({
	    //     element:opts.wrapEl,
	    //     scrollArea : window,
	    ...
	    //                  // 插入数据到页面，放到最后面
	    //                  $(opts.listEl).append(result);
	    //                  // 每次数据插入，必须重置
	    //                  me.resetload();
	    //             	}else{
	    //             		toast.getInstance().show('',err.msg)
	    //             	}
	    //             }
	    //         });
	    //     }
	 ...
	 */
	function _submitBillRushRed(api, params) {
	    (0, _ajax2.default)({
	        url: api,
	        data: params,
	        done: function done(err, res) {
	            if (!err) {
	                _toast2.default.getInstance().show('', '操作成功');
	                var $billItem = $('.invoice-item[data-id="' + params.billNoteId + '"]');
	                $billItem.removeClass('success').find('.status-str').text('作废');
	            } else {
	                _toast2.default.getInstance().show('', err.msg);
	            }
	        }
	...
	function _initBillRushRedDialog() {
	    var that = this;
	    _billRushRedDialog = _dialog3.default.create({
	        title: '作废理由',
	        content: '',
	        tapMaskToClose: false,
	        closeBtn: false,
	        buttons: [{
	            ...
	            action: function action() {
	                ...
	                var billNoteId = $('#billNoteId').val();

	                _submitBillRushRed(that.opts.saveBillRushRedApi, {
	                    billNoteId: billNoteId,
	                    reason: reason,
	...
	_base2.default.create('ipark.invoice.list', function () {
	    return {
	        init: function init(opts) {
	            this.opts = opts;
	            openId = opts.openId;
	            changeApi = opts.changeApi;
	            _initList.call(this);
	            _initDialog();
	            _initBillRushRedDialog.call(this);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"bill-form\">\r\n	<input type=\"hidden\" id=\"billNoteId\" value=\""
	    + container.escapeExpression(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},{"name":"id","hash":{},"data":data}) : helper)))
	    + "\">\r\n	<textarea name=\"\" id=\"reason\" placeholder=\"请输入作废理由\" rows=\"3\"></textarea>\r\n</div>";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams,depths) {
	  ...
	  return "<li class=\"invoice-item "
	    + ((stack1 = __default(__webpack_require__(675)).call(alias1,(depth0 != null ? depth0.status : depth0),{"name":"isInvoiceSucc","hash":{},"fn":container.program(2, data, 0, blockParams, depths),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "\" data-id=\""
	    + alias3(alias2((depth0 != null ? depth0.billnoteId : depth0), depth0))
	    + "\">\r\n	<div class=\"invoice-item-info\">\r\n		<div class=\"invoice-entry\">\r\n			<label for=\"\">\r\n				发票抬头：<span>"
	    + alias3(alias2((depth0 != null ? depth0.billTitle : depth0), depth0))
	    + "</span>\r\n			</label>\r\n"
	    + ((stack1 = __default(__webpack_require__(693)).call(alias1,(depth0 != null ? depth0.status : depth0),{"name":"isError","hash":{},"fn":container.program(4, data, 0, blockParams, depths),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "		</div>\r\n		<!-- <div class=\"invoice-entry\">\r\n			<label for=\"\">\r\n				发票类型：<span id=\"billKind\">"
	    + alias3(__default(__webpack_require__(690)).call(alias1,(depth0 != null ? depth0.isAdd : depth0),{"name":"billTbKindStr","hash":{},"data":data}))
	    + "</span>\r\n			</label>\r\n			<div class=\"right-value status-str\" id=\"billkindStatus\" data-back-msg=\""
	    + alias3(alias2((depth0 != null ? depth0.backMsg : depth0), depth0))
	    + "\">\r\n				"
	    + ((stack1 = alias2((depth0 != null ? depth0.status : depth0), depth0)) != null ? stack1 : "")
	    + "\r\n			</div>\r\n		</div> -->\r\n		<div class=\"invoice-entry\">\r\n			<label for=\"\">\r\n				消费类型：<span>"
	    + alias3(__default(__webpack_require__(691)).call(alias1,(depth0 != null ? depth0.billTbtype : depth0),{"name":"billTbTypeStr","hash":{},"data":data}))
	    + "</span>\r\n			</label>\r\n			<a href=\""
	    + alias3(__default(__webpack_require__(695)).call(alias1,(depths[1] != null ? depths[1].expenseListUrl : depths[1]),{"name":"urlFormat","hash":{},"data":data}))
	    + "\" class=\"invoice-check\">"
	    + alias3(alias2((depth0 != null ? depth0.logSum : depth0), depth0))
	    + "次消费</a>\r\n		</div>\r\n		<div class=\"invoice-entry\">\r\n			<label for=\"\">\r\n				发票金额：<span>"
	    + alias3(__default(__webpack_require__(298)).call(alias1,(depth0 != null ? depth0.fee : depth0),{"name":"cent2yuan","hash":{},"data":data}))
	    + "元</span>\r\n			</label>\r\n		</div>\r\n		<div class=\"invoice-entry\">\r\n			<label for=\"\">\r\n				申请时间：<span>"
	    + alias3(__default(__webpack_require__(196)).call(alias1,(depth0 != null ? depth0.createDt : depth0),"yyyy-MM-dd hh:mm",{"name":"timestamp2date","hash":{},"data":data}))
	    + "</span>\r\n			</label>\r\n			<!-- <div class=\"right-value status-str\" data-back-msg=\""
	    + alias3(alias2((depth0 != null ? depth0.backMsg : depth0), depth0))
	    + "\">\r\n				"
	    + ((stack1 = __default(__webpack_require__(694)).call(alias1,(depth0 != null ? depth0.status : depth0),(depth0 != null ? depth0.viewUrl : depth0),{"name":"statuStr","hash":{},"data":data})) != null ? stack1 : "")
	    + "\r\n			</div> -->\r\n		</div>\r\n"
	    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.isChange : depth0),{"name":"if","hash":{},"fn":container.program(6, data, 0, blockParams, depths),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "	</div>\r\n"
	    + ((stack1 = __default(__webpack_require__(675)).call(alias1,(depth0 != null ? depth0.status : depth0),{"name":"isInvoiceSucc","hash":{},"fn":container.program(8, data, 0, blockParams, depths),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "</li>\r\n";
	  ...
	  return "			<div class=\"right-value\">\r\n			<div class=\"right-value status-str\" id=\"billkindStatus\" data-back-msg=\""
	    + container.escapeExpression(alias1((depth0 != null ? depth0.backMsg : depth0), depth0))
	    + "\">\r\n				"
	    + ((stack1 = alias1((depth0 != null ? depth0.status : depth0), depth0)) != null ? stack1 : "")
	    + "\r\n			</div>\r\n				\r\n			</div>\r\n";
	},"6":function(container,depth0,helpers,partials,data) {
	    return "			<button class=\"change\" id=\"change\">变更</button>\r\n";
	},"8":function(container,depth0,helpers,partials,data) {
	    return "	<button class=\"invoice-item-del\">\r\n		作废\r\n	</button>\r\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams,depths) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.data : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0, blockParams, depths),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"useData":true,"useDepths":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	    return "	<div class=\"tooltip\">\r\n		<div class=\"text\">请填写变更发票原因：</div>\r\n		<textarea class=\"textarea\"></textarea> \r\n	</div>\r\n";
	},"3":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return ((stack1 = helpers["if"].call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.checkRemind : depth0),{"name":"if","hash":{},"fn":container.program(4, data, 0),"inverse":container.program(6, data, 0),"data":data})) != null ? stack1 : "");
	},"4":function(container,depth0,helpers,partials,data) {
	    var helper;

	  return "		<div class=\"tooltip\">\r\n			<div class=\"text\">"
	    + container.escapeExpression(((helper = (helper = helpers.checkRemind || (depth0 != null ? depth0.checkRemind : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},{"name":"checkRemind","hash":{},"data":data}) : helper)))
	    + "</div>\r\n		</div>\r\n";
	},"6":function(container,depth0,helpers,partials,data) {
	    var helper;

	  return "		<div class=\"tooltip\">\r\n			<div class=\"title\">提交成功</div>\r\n			<div class=\"text\">"
	    + container.escapeExpression(((helper = (helper = helpers.checkResult || (depth0 != null ? depth0.checkResult : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},{"name":"checkResult","hash":{},"data":data}) : helper)))
	    + "</div>\r\n		</div>\r\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return ((stack1 = helpers["if"].call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.checkType : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(3, data, 0),"data":data})) != null ? stack1 : "");
	},"useData":true});
