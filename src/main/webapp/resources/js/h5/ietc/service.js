...
/***/ function(module, exports, __webpack_require__) {
	...
	var PhoneRender = __webpack_require__(771);

	_base2.default.create('ietc.service', function () {
		return {
			init: function init(opts) {
				var phoneHtml = PhoneRender({
					phones: opts.phones
				});
				$('#phone-list').empty().append(phoneHtml);
			}
		};
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.phones : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"useData":true});
