...
/***/ function(module, exports, __webpack_require__) {
	...
	var Symbol = __webpack_require__(678),
	    getRawTag = __webpack_require__(705),
	    objectToString = __webpack_require__(710);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var root = __webpack_require__(680);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var freeGlobal = __webpack_require__(679);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseTimes = __webpack_require__(700),
	    isArguments = __webpack_require__(714),
	    isArray = __webpack_require__(681),
	    isBuffer = __webpack_require__(715),
	    isIndex = __webpack_require__(706),
	    isTypedArray = __webpack_require__(719);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createBaseFor = __webpack_require__(704);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseGetTag = __webpack_require__(551),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isPrototype = __webpack_require__(707),
	    nativeKeys = __webpack_require__(708);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var identity = __webpack_require__(713);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isArrayLike = __webpack_require__(682);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var overArg = __webpack_require__(711);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(module) {var freeGlobal = __webpack_require__(679);
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(684)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var arrayEach = __webpack_require__(692),
	    baseEach = __webpack_require__(694),
	    castFunction = __webpack_require__(702),
	    isArray = __webpack_require__(681);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(module) {var root = __webpack_require__(680),
	    stubFalse = __webpack_require__(721);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseGetTag = __webpack_require__(551),
	    isObject = __webpack_require__(718);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseIsTypedArray = __webpack_require__(698),
	    baseUnary = __webpack_require__(701),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var arrayLikeKeys = __webpack_require__(693),
	    ...
	    isArrayLike = __webpack_require__(682);
...
/***/ function(module, exports, __webpack_require__) {
	...
	//选择日期
	var isNil = __webpack_require__(717);
	var forEach = __webpack_require__(712);
	__webpack_require__(802);
	_index2.default.create('fee.scan', function () {

		var plateNo = ""; //车牌号
		var plateColor = '02'; //车牌颜色，默认蓝色
		var color = [//所有车牌
		{ label: "蓝", value: "02" }, { label: "黄", value: "01" }, { label: "黑", value: "03" }, { label: "白", value: "20" }, { label: "绿", value: "26" }];
		...
		function _getAjax(Api, parkNo, opts) {
			...
			(0, _ajax2.default)({
				...
				data: {
					...
					parkNo: parkNo,
					openId: opts.openId,
					wxAppId: opts.wxAppId,
					aliUserId: opts.aliUserId,
					aliAppId: opts.aliAppId
				},
		...
		function _setInPic(data) {
			var imgUrl = data.pic;
			$('.img').css({
				'background-image': 'url(' + imgUrl + '_632-357-cm.jpg)'
			});
		}
		function _initPage() {
			$('#carPlate').val('');
		...
		function _bindEvent() {
			...
			var wxAppId = this.opts.wxAppId;
			var voucherCode = this.opts.voucherCode;
			var openId = this.opts.openId;
			var parkNo = this.opts.parkNo;
			var opts = this.opts;

			var length; //输入的长度
			$('#colorPlate').on('click', function () {
				//选择车牌颜色
				_picker2.default.picker(color, {
					selected: [plateColor],
					onChange: function onChange(result) {},
					disabled: function disabled(value) {},
					onConfirm: function onConfirm(result) {
						plateColor = result.toString();
						$('#colorPlate').text(colorMapping[result.toString()]);
					}
				});
			});
			$('#confirm').on('click', function () {
				var express = /^[\u4e00-\u9fa5]{1}[A-Z_a-z]{1}[A-Z_0-9_a-z]{5}[A-Z_0-9_a-z]*$/; //车牌正则表达式
				if ($('#carPlate').val() == null || $('#carPlate').val() == "") {
					_toast2.default.getInstance().show('', "请输入车牌号！");
				} else if (!$('#carPlate').val().match(express)) {
					_toast2.default.getInstance().show('', "您输入的车牌不正确！");
				} else {
					var paramMap = {
						plateNo: plateNo,
						plateColor: plateColor
					};
					forEach(paramMap, function (value, key) {
						if (!isNil(value)) {
							url += '&' + key + '=' + value;
						}
					});
