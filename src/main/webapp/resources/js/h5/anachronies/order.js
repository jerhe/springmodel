...
var PullLoad = function (_Util$Component) {
  _inherits(PullLoad, _Util$Component);

  function PullLoad(opts) {
    _classCallCheck(this, PullLoad);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(PullLoad).call(this));

    _this.config = {};
    _this.container = null; //具有scroll的容器
    _this.wrapper = null; //结构外包围元素
    _this.loaderBody = null; //DOM 对象
    _this.loaderSymbol = null; //DOM 对象
    _this.loaderBtn = null; //DOM 对象
    _this.loaderState = STATS.init;
    _this.hasMore = true; //是否有加载更多
    _this.startX = 0; //用于保存touchstart时初始位置
    _this.startY = 0; //用于保存touchstart时初始位置
    _this.init(opts);
    return _this;
  }

  _createClass(PullLoad, [{
    key: 'init',
    ...
    key: 'onPullDownMove',
    value: function onPullDownMove(startY, y) {
    ...
    value: function onPullDownRefresh() {
      if (this.loaderState === STATS.refreshing) {
        ...
        if (typeof this.config.onRefresh === "function") {
          this.config.onRefresh(bind(function () {
    ...
    key: 'onPullUpMove',
    value: function onPullUpMove(staartY, y) {
    ...
    key: 'setChange',
    value: function setChange(pullHeight, state) {
    ...
    key: 'setClassName',
    value: function setClassName(state) {
    ...
    key: 'setEndState',
    value: function setEndState() {
      this.setChange(0, STATS.reset);
    }
  }, {
    key: 'setNoMoreState',
    value: function setNoMoreState() {
...
PullLoad.create = function (opts) {
  return new PullLoad(opts);
};
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"empty-wrap\">\r\n    <div class=\"empty-img "
    ...
    + alias4(((helper = (helper = helpers.emptyInfo || (depth0 != null ? depth0.emptyInfo : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"emptyInfo","hash":{},"data":data}) : helper)))
    + "</div>\r\n</div>";
},"useData":true});
...
//引入模板
var tplRender = __webpack_require__(46);
...
// removed by extract-text-webpack-plugin
module.exports = {"wraper":"components-toast-toast__wraper___23El_","inner":"components-toast-toast__inner___1dhzQ"};
...
// removed by extract-text-webpack-plugin
module.exports = {"wraper":"components-loading-loading__wraper___3I-My","show":"components-loading-loading__show___xCeQN","inner":"components-loading-loading__inner___2aDe6","icon":"components-loading-loading__icon___2--sd","rotate":"components-loading-loading__rotate___30X12"};
...
function ajax(opts) {
	...
	$.ajax({
		...
		url: opts.url,
		data: opts.data,
		beforeSend: opts.before ? opts.before : function () {},
		complete: opts.complete ? opts.complete : function () {}
	}).done(function (data) {
...
module.exports = function (status, value, options) {
    var result = false;
    if (status == value) {
        result = true;
    } else {
...
//引入模板
var tplRender = __webpack_require__(76);
...
function bindEvent() {
	...
	$this.find("." + style.button).on("tap", function () {
...
function removeEvent() {
	...
	$closeBtn.off('tap', function () {
		self.hide();
	});

	$this.find("." + style.button).off("tap", function () {
		var buttons = self.options.buttons;
		var index = $(this).index();
		buttons[index].action.call(self);
	});
...
module.exports = function (value, equelValue, options) {
	var result = value ? equelValue : !equelValue;
	if (result) {
		return options.fn(this);
	} else {
		return options.inverse(this);
...
// removed by extract-text-webpack-plugin
module.exports = {"wraper":"components-dialog-dialog__wraper___27i7a","default":"components-dialog-dialog__default___2IvF1","active":"components-dialog-dialog__active___1pM0a","inner":"components-dialog-dialog__inner___25IJm","show":"components-dialog-dialog__show___2oQ6j","icon":"components-dialog-dialog__icon___2Qxaz","header":"components-dialog-dialog__header___2qoFd","body":"components-dialog-dialog__body___1ZDUN","footer":"components-dialog-dialog__footer___33F7b","button":"components-dialog-dialog__button___2NDld","close":"components-dialog-dialog__close___B9mPL","blue":"components-dialog-dialog__blue___2DwbN","hide":"components-dialog-dialog__hide___3d7wz"};
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\""
    ...
    + ";text-indent:"
    + alias2(((helper = (helper = helpers.textIndent || (depth0 != null ? depth0.textIndent : depth0)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"textIndent","hash":{},"data":data}) : helper)))
    + "\">\r\n			"
...
var _pullLoad = __webpack_require__(214);
...
var _orderTpl = __webpack_require__(902);

var _orderTpl2 = _interopRequireDefault(_orderTpl);

var _dialog2 = __webpack_require__(74);

var _dialog3 = _interopRequireDefault(_dialog2);

var _dialogTpL = __webpack_require__(904);

var _dialogTpL2 = _interopRequireDefault(_dialogTpL);
...
__webpack_require__(33);
__webpack_require__(905); //对话框


_base2.default.create('anachronies.order', function () {
    var pageIndex = 1;
    var currentPage = null;
    var _dialog;
    var orderCache = [];
    function _getData(pageNum, pageSize, flag, cb) {
        _loading2.default.getInstance().show();
        (0, _ajax2.default)({
            url: this.opts.api,
            data: {
                ...
                if (!err) {
                    var pages = res.pages;
                    currentPage = pages;
                    var carports = res.orders;
                    if (carports.length > 0) {
                        if (flag) {
                            orderCache = _.concat(orderCache, carports);
                        } else {
                            orderCache = carports;
                        }
                        cb(carports, pages, true, null);
                    } else {
                        cb([], {}, true, '暂无数据');
                    }
                } else {
    ...
    function _renderList(data, pages, flag, msg) {
        var that = this;
        var $wrap = $('.tloader-body');
        var orderHtml = (0, _orderTpl2.default)({
            data: data,
            emptyInfo: '暂无预订订单',
            userClass: ''
        });
        ...
        if (flag) {
            $wrap.append(orderHtml);
        } else {
            $wrap.empty().append(orderHtml);
        }
    }

    function _initPullLoad() {
        var _this = this;

        var that = this;
        var installObj = new _pullLoad2.default({
            container: document.body,
            wrapper: document.getElementById(this.opts.containerEl),
            downEnough: 50,
            onRefresh: function onRefresh(success, error) {
                pageIndex = 1;
                _getData.bind(_this)(pageIndex, _this.opts.pageSize, false, function (data, pages, flag, msg) {
                    _renderList.bind(that)(data, pages, false, msg);
                    success();
                });
            },
            onLoadMore: function onLoadMore(success, error) {
                pageIndex += 1;
                if (currentPage.totalPages >= pageIndex) {
                    _getData.bind(_this)(pageIndex, _this.opts.pageSize, true, function (data, pages, flag, msg) {
                        _renderList.bind(that)(data, pages, true, msg);
                        if (pages.totalPages >= pageIndex) {
                            success(false);
                        } else {
                            success(true);
                        }
    ...
    function _bindEvent() {
        var that = this;
        $('.tloader-body').on('tap', '.modify', function (e) {
            e.stopPropagation();
        });

        $('.tloader-body').on('tap', '.carport-item', function (e) {
            ...
            if (className == 'modify' || className == 'renew') {
                return;
            } else {
                var url = that.opts.orderDetailUrl.replace(/\{(.*?)\}/g, function (match, key) {
                    return params[key];
                });
                location.href = url;
            }
        ...
        $('.tloader-body').on('tap', '.renew', function (e) {
            e.stopPropagation();
            var $li = $(this).parent().parent();
            var orderId = $li.data('orderid');
            var orderItem = _.find(orderCache, function (item) {
                return item['orderId'] == orderId;
            });

            var params = {
                openId: that.opts.openId,
                preInfoId: orderItem.preInfoId,
                parkId: orderItem.parkId,
                orderId: orderItem.orderId,
                startDate: orderItem.startDate,
                endDate: orderItem.endDate
            };
            (0, _ajax2.default)({
                url: that.opts.scheduleParkApi,
                data: params,
                done: function done(error, data, full) {
                    if (error) {
                        _toast2.default.getInstance().show('', error.msg);
                    } else {
                        var dialogOpt;
                        var extParam = $.extend({}, orderItem, {
                        ...
                        if (data.status == "1") {
                            //有车位
                            var url = decodeURI(that.opts.scheduleDetailUrl).replace(/\{(.*?)\}/g, function (match, key) {
                                return extParam[key];
                            });
                            location.href = url;
                        } else if (data.status == "3") {
                            //没有连续车位，但可以预约车位
                            var date = new Date(extParam.orderEnddtFmt + 86400000);
                            var time = date.getFullYear() + "-" + (date.getMonth() + 1) + "-" + date.getDate();
                            var url = that.opts.parkDetailUrl.replace(/\{(.*?)\}/g, function (match, key) {
                                return extParam[key];
                            });
                            dialogOpt = {
                                title: '提示',
                                dataType: 'content',
                                content: (0, _dialogTpL2.default)({
                                    status: data.status,
                                    isParking: true,
                                    time: time
                                }),
                            ...
                            dialogOpt = (_dialogOpt = {
                            ...
                            }, _defineProperty(_dialogOpt, 'closeBtn', false), _defineProperty(_dialogOpt, 'tapMaskToClose', false), _defineProperty(_dialogOpt, 'buttons', [{
                                display: "我知道了",
                                action: function action() {
                                    this.hide();
                                }
                                ...
                                display: '其他车场',
                                action: function action() {
                                    location.href = that.opts.parkListUrl;
                                }
                            }]), _dialogOpt);
                        } else if (data.status == "4") {
                            var _dialogOpt2;

                            dialogOpt = (_dialogOpt2 = {
                                title: '提示',
                                closeBtn: false,
                                tapMaskToClose: false,
                                dataType: 'content',
                            ...
                            }, _defineProperty(_dialogOpt2, 'closeBtn', false), _defineProperty(_dialogOpt2, 'tapMaskToClose', false), _defineProperty(_dialogOpt2, 'buttons', [{
                                display: "我知道了",
                                action: function action() {
                                    this.hide();
                                }
                        ...
                        if (dialogOpt) {
                            var _dialog = _dialog3.default.create(dialogOpt);
                            _dialog.render(dialogOpt).show();
                        }
                    }
                }
            });
    ...
    return {
        init: function init(opts) {
            this.opts = opts;
            _initPullLoad.call(this);
            _getData.call(this, this.opts.pageIndex, this.opts.pageSize, false, _renderList.bind(this));
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.data : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
},"2":function(container,depth0,helpers,partials,data) {
    var stack1, alias1=depth0 != null ? depth0 : {}, alias2=container.lambda, alias3=container.escapeExpression;

  return "    <ul class=\"carport-list\">\r\n        <li class=\"carport-item "
    + ((stack1 = __default(__webpack_require__(742)).call(alias1,(depth0 != null ? depth0.overdue : depth0),1,{"name":"isOverDue","hash":{},"fn":container.program(3, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "\" data-orderId=\""
    + alias3(alias2((depth0 != null ? depth0.orderId : depth0), depth0))
    + "\" data-feeId=\""
    + alias3(alias2((depth0 != null ? depth0.feeId : depth0), depth0))
    + "\">\r\n            <div class=\"item-list\">\r\n                <div class=\"item-text\">停放车辆</div>\r\n                <div class=\"item-content\">"
    + alias3(alias2((depth0 != null ? depth0.plateNo : depth0), depth0))
    + "</div>\r\n                <div class=\"park-type "
    + alias3(__default(__webpack_require__(903)).call(alias1,(depth0 != null ? depth0.preType : depth0),{"name":"parkType","hash":{},"data":data}))
    + "\">"
    + alias3(__default(__webpack_require__(645)).call(alias1,(depth0 != null ? depth0.preType : depth0),{"name":"formatPreType","hash":{},"data":data}))
    + "</div>\r\n            </div>\r\n            <div class=\"item-list\">\r\n                <div class=\"item-text\">预定车位</div>\r\n                <div class=\"item-content\">"
    + alias3(alias2((depth0 != null ? depth0.parkName : depth0), depth0))
    + "</div>\r\n            </div>\r\n            <div class=\"item-list\">\r\n                <div class=\"item-text\">停放时段</div>\r\n                <div class=\"item-content\">\r\n"
    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.startTime : depth0),{"name":"if","hash":{},"fn":container.program(5, data, 0),"inverse":container.program(7, data, 0),"data":data})) != null ? stack1 : "")
    + "                </div>\r\n            </div>\r\n"
    + ((stack1 = __default(__webpack_require__(742)).call(alias1,(depth0 != null ? depth0.isContinue : depth0),0,{"name":"isOverDue","hash":{},"fn":container.program(9, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "        </li>\r\n    </ul>\r\n";
},"3":function(container,depth0,helpers,partials,data) {
    return "overdue";
  ...
  return "                        "
    ...
    return "                <div class=\"item-list flex\">\r\n                    <button type=\"button\" class=\"renew\">续订车位</button>\r\n                </div>\r\n";
},"11":function(container,depth0,helpers,partials,data) {
    var stack1;

  return ((stack1 = container.invokePartial(__webpack_require__(329),depth0,{"name":"emptyWrap","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "");
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1;

  return ((stack1 = helpers["if"].call(depth0 != null ? depth0 : {},((stack1 = (depth0 != null ? depth0.data : depth0)) != null ? stack1.length : stack1),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(11, data, 0),"data":data})) != null ? stack1 : "");
...
function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
    return "    <div>续订失败。很抱歉，该停车场"
    + container.escapeExpression(container.lambda((depth0 != null ? depth0.time : depth0), depth0))
    + "的停车位已全被预订。您可以预定其他时段的车位~</div>\r\n";
},"3":function(container,depth0,helpers,partials,data) {
    var stack1;

  return ((stack1 = __default(__webpack_require__(646)).call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.status : depth0),3,{"name":"status2bool","hash":{},"fn":container.program(4, data, 0),"inverse":container.program(6, data, 0),"data":data})) != null ? stack1 : "");
},"4":function(container,depth0,helpers,partials,data) {
    return "    <div>续订失败。很抱歉，该车场的停车位已经全部被预订，到其他停车场看看吧~</div>\r\n";
},"6":function(container,depth0,helpers,partials,data) {
    var stack1;

  return ((stack1 = __default(__webpack_require__(646)).call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.status : depth0),4,{"name":"status2bool","hash":{},"fn":container.program(7, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
},"7":function(container,depth0,helpers,partials,data) {
    return "    <div>续订失败。很抱歉，该停车场的停车位已经停止接受预订，到其他停车场看看吧~</div>\r\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1;

  return ((stack1 = __default(__webpack_require__(646)).call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.status : depth0),2,{"name":"status2bool","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(3, data, 0),"data":data})) != null ? stack1 : "");
},"useData":true});
