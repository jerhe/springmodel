...
public class CommonIdStrGenerator implements IdGenerator<String> {
    ...
    public CommonIdStrGenerator(long workerId) {
    ...
    static void initWorkerId() {
        String workerIdStr = Global.getConfig("id.generator.worker.id", StringUtils.EMPTY);
    ...
    public static void setWorkerId(final Long workerId) {
        ...
        CommonIdStrGenerator.workerId = workerId;
    }
    ...
    public synchronized String generateId() {
        ...
        String id = String.valueOf(((time - SJDBC_EPOCH) << TIMESTAMP_LEFT_SHIFT_BITS)
                | (workerId << WORKER_ID_LEFT_SHIFT_BITS) | sequence);
        return id;
    }
    ...
    public static void setClock(AbstractClock clock) {
        CommonIdStrGenerator.clock = clock;
    }
